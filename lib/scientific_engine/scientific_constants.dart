class ScientificConstants {
  ...
  static const double confidenceThresholdLow =
      0.50; // Below this is insufficient confidence
  static const double confidenceThresholdModerate =
      0.75; // Between 0.50 and 0.75 is moderate
  ...
  static const double deltaEAcceptable =
      10.0; // Noticeable difference but matching
