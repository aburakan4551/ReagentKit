...
class ScientificReferencesRegistry {
  static List<ScientificReference> getReferencesForSubstance(String substance, String languageCode) {
    ...
    if (normalized.contains('cocaine') || normalized.contains('كوكايين')) {
      return [
        ScientificReference(
          sourceName: 'PubChem',
          title: isAr ? 'كوكايين - PubChem CID 446220' : 'Cocaine - PubChem CID 446220',
          description: isAr 
        ...
        ScientificReference(
          sourceName: 'DrugBank',
          title: isAr ? 'كوكايين - DrugBank DB00907' : 'Cocaine - DrugBank DB00907',
          description: isAr
    ...
    } else if (normalized.contains('mdma') || normalized.contains('ecstasy') || normalized.contains('إكستاسي')) {
      return [
        ScientificReference(
          sourceName: 'PubChem',
        ...
        ScientificReference(
          ...
          title: isAr ? 'بيانات الطيف لـ MDMA - NIST' : 'MDMA Spectral Data - NIST',
          description: isAr
    ...
    } else if (normalized.contains('heroin') || normalized.contains('هيروين') || 
               normalized.contains('morphine') || normalized.contains('مورفين') || 
               normalized.contains('opium') || normalized.contains('أفيون') ||
               normalized.contains('opiate') || normalized.contains('أفيونات')) {
      return [
        ScientificReference(
          sourceName: 'PubChem',
          title: isAr ? 'هيروين - PubChem CID 5462328' : 'Heroin - PubChem CID 5462328',
          description: isAr
        ...
        ScientificReference(
          sourceName: 'WHO',
          title: isAr ? 'تقرير منظمة الصحة العالمية بشأن المواد الأفيونية' : 'WHO Opiates Information',
          description: isAr
    ...
    } else if (normalized.contains('amphetamine') || normalized.contains('أمفيتامين') || 
               normalized.contains('methamphetamine') || normalized.contains('ميثامفيتامين') ||
               normalized.contains('stimulant') || normalized.contains('منشطات')) {
      return [
        ScientificReference(
          sourceName: 'PubChem',
          title: isAr ? 'أمفيتامين - PubChem CID 3007' : 'Amphetamine - PubChem CID 3007',
          description: isAr
        ...
        ScientificReference(
          sourceName: 'NIH / NIDA',
          title: isAr ? 'المعهد الوطني لمكافحة إساءة استخدام العقاقير (NIDA)' : 'NIH / NIDA Methamphetamine Report',
          description: isAr
          ...
          url: 'https://nida.nih.gov/publications/research-reports/methamphetamine',
        ),
      ];
    } else if (normalized.contains('psilocybin') || normalized.contains('سيلوسيبين')) {
      return [
        ScientificReference(
          sourceName: 'PubChem',
          title: isAr ? 'سيلوسيبين - PubChem CID 4980' : 'Psilocybin - PubChem CID 4980',
          description: isAr
        ...
        ScientificReference(
          sourceName: 'DrugBank',
          title: isAr ? 'سيلوسيبين - DrugBank DB14746' : 'Psilocybin - DrugBank DB14746',
          description: isAr
    ...
    } else if (normalized.contains('cannabis') || normalized.contains('thc') || 
               normalized.contains('cannabinoid') || normalized.contains('حشيش') || 
               normalized.contains('قنب') || normalized.contains('ماريجوانا')) {
      return [
        ScientificReference(
          sourceName: 'PubChem',
          title: isAr ? 'تتراهيدروكانابينول - PubChem CID 16078' : 'Tetrahydrocannabinol - PubChem CID 16078',
          description: isAr
        ...
        ScientificReference(
          sourceName: 'WHO',
          title: isAr ? 'تقرير منظمة الصحة العالمية حول الحشيش وقنب الهند' : 'WHO Cannabis Report',
          description: isAr
          ...
          url: 'https://www.who.int/teams/mental-health-and-substance-use/alcohol-drugs-and-addictive-behaviours/drugs/cannabis',
        ),
      ];
    } else if (normalized.contains('ketamine') || normalized.contains('كيتامين')) {
      return [
        ScientificReference(
          sourceName: 'PubChem',
          title: isAr ? 'كيتامين - PubChem CID 3821' : 'Ketamine - PubChem CID 3821',
          description: isAr
        ...
        ScientificReference(
          sourceName: 'DrugBank',
          title: isAr ? 'كيتامين - DrugBank DB01221' : 'Ketamine - DrugBank DB01221',
          description: isAr
      ...
      return [
        ScientificReference(
          sourceName: 'PubChem',
          title: isAr ? 'N,N-ثنائي ميثيل تريبتامين - PubChem CID 6089' : 'N,N-Dimethyltryptamine - PubChem CID 6089',
          description: isAr
